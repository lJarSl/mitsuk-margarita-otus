...
### Для проверки:
1.  запустить mongodb
2.  перейти в каталог node/rssGrabber/
3.  выполнить в консоли: npm start
4.  результаты работы скрипта выводятся в консоль
...
### Для проверки:
1.  перейти в каталог angular/myDictionary
2.  выполнить в консоли: npm install (если необходимо)
3.  выполнить в консоли: ng serve --open
5.  результаты работы скрипта выводятся в консоль
